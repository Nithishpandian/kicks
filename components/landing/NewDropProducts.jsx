...
export default function NewDropProducts({ product, button }) {
  return (
    <div className=" flex items-center justify-center w-72 md:w-80">
      <div className=" flex justify-center items-center w-fit max-w-[400px]">
        <div className=" flex flex-col gap-1 sm:gap-3">
          <Image
            className=" bg-white p-2 rounded-2xl min-w-72 w-full max-w-[400px]"
            src={product.imageUrl}
            alt="Shoe1_img"
          />
          <h1 className=" text-xl sm:text-2xl font-black text-[#232321]">
            {product.name}
          </h1>
